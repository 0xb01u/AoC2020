...
At this point, all that is left is for you to [admire your Advent calendar](https://adventofcode.com/2020).

If you still want to see it, you can [get your puzzle input](https://adventofcode.com/2020/day/25/input).
