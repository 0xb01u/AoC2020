...
canonical_list = reduce(lambda x, y: x + y[1] + ',', sorted([(e[0], e[1].pop()) for e in allergy_table.items()]), '')[:-1]
print(f"Canonical dangerous ingredient list: {canonical_list}")
assert canonical_list == "kbmlt,mrccxm,lpzgzmk,ppj,stj,jvgnc,gxnr,plrlg"
